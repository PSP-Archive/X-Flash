...
if (fnc == 1) {
	printf("                   6 APPLY ORIGINAL XMB MENU ICONS      ");
}
...
if (month == 17) {
	...
	if (fnc == 1) {
	printf("      ;`-';   Restore the original main icons that are   ;`-';");
	pspDebugScreenSetXY(0, 27);
	printf("      ;.-.;   customised with the icon editor by kgsws.  ;.-.;");
	pspDebugScreenSetXY(0, 28);
	printf("      ;`-';    You will still be able to use the menu    ;`-';");
	pspDebugScreenSetXY(0, 29);
	printf("      ;.-.;  label editor if you keep the topmenu file.  ;.-.;");
	pspDebugScreenSetXY(0, 30);
	printf("      ;`-';  Any customised icons will be overwritten.   ;`-';");
	}
	}
...
sigset = 0x30 + 0x07;	// set ram signature
}
